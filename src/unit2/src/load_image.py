...
def main():                                        #main function
    ...
    img = cv2.imread('/home/user/catkin_ws/src/opencv_for_robotics_images/Unit_2/Course_images/test_image_1.jpg') #Reads a test image from a specified path using OpenCV
